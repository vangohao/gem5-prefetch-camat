...
void l2_prefetcher_initialize(int cpu_num)
{
  ...
  // you can inspect these knob values from your code to see which
  // configuration you're runnig in
...
{
  // uncomment this line to see all the information available to make prefetch
  //  decisions
  //  printf("(%lld 0x%llx 0x%llx %d %d %d) ", get_current_cycle(0), addr,
  //  ip, cache_hit, get_l2_read_queue_occupancy(0), get_l2_mshr_occupancy(0));
...
{
  // uncomment this line to see the information available to you when there is
  // a cache fill event
