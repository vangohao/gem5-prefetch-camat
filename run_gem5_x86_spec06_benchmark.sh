...
GEM5_DIR=/home/hui-shun/UW/cs752/gem5                      # Install location of gem5
SPEC_DIR=/home/hui-shun/UW/cs752/cpu2006                    # Install location of your SPEC2006 benchmarks
##################################################################
...
$GEM5_DIR/build/X86/gem5.opt --outdir=$OUTPUT_DIR $GEM5_DIR/configs/example/spec06_se.py --benchmark=$BENCHMARK --benchmark_stdout=$OUTPUT_DIR/$BENCHMARK.out --benchmark_stderr=$OUTPUT_DIR/$BENCHMARK.err | tee -a $SCRIPT_OUT
